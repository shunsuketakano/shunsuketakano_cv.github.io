...
ここに，$$\{c_{\Gamma_\alpha}^i\}$$は展開係数である．例えば，高温相における物理量は，$$G_0$$の既約表現の基底の線型結合となる．ここで，$$G_0$$の（全対称表現でない）既約表現が，低温相の既約表現となる場合がある．正確には，$$G_0$$における（全対称表現でない）既約表現$$\Gamma_0$$について，低温相の対称群$$G$$に制限することで$$\Gamma, \Gamma_1,\dots$$に既約分解され，さらに，その中に$$G$$の全対称表現が含まれていることがある．その$$G$$における全対称表現を$$\Gamma$$と書くとき，$$\Gamma$$の基底函数$$\eta$$が秩序変数である．なお，$$\Gamma_0$$の選択は一意とは限らないため，この$$\eta$$にも複数の候補があり得る．秩序変数とは {% cite 清水2021熱力学II %} の解説が納得である．
