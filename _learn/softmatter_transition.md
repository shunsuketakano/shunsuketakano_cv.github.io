...
を考え，その展開係数$$\{P_x, P_y\}を秩序変数とする．基底函数の組み$$\{\cos{\phi}, \sin{\phi}\}$$に係数$$P$$をかけた$$\mathbf{P} = (P_x, P_y)$$を秩序変数に選択する．他にも，$$\{\cos{\phi}, \sin{\phi}\}$$も同様に振る舞う．これは分極と称され，ミクロには，単位体積内の双極子モーメントを足し合わせたものである．
