...
\begin{align}
    ...
    ,\\
    c_V(T < T^\ast) 
    &\simeq \frac{1}{2b} \left(\left.\frac{\partial a}{\partial T}\right|_{T=T^\ast}\right)^2 T (T / T^\ast - 1)^{-\alpha}
    ,\hspace{1em} \alpha = 0
\end{align}
$$
...
\begin{equation}
    ...
    = \frac{1}{2b} \left(\left.\frac{\partial a}{\partial T}\right|_{T=T^\ast}\right)^2 T^\ast
\end{equation}
$$

となる．ただし，有限の跳躍が生じるのはLandau理論の特徴であり，多くの連続相転移では比熱の跳躍が生じないか，比熱が発散することが知られている．
