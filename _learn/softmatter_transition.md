...
である．ただし，秩序変数が関与しない自由エネルギーの成分$$F_0$$による寄与が，別途必要である．相転移温度$$T^\ast$$において，エントロピーは連続であることがわかる．Ehrenfestの定義に則ると，Landau理論は連続相転移を記述するといえる．いま，系の体積が温度に依存しない場合には，このエントロピーから（体積あたりの）定積比熱$$c_V$$が
