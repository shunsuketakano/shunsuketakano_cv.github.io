...
熱平衡状態では，自由エネルギーが最小である．すなわち，自由エネルギー$$\bar{F}$$は秩序変数$$\eta$$に対し下に凸である．しかし，現象論的自由エネルギーは（後の例をみればわかるように）低温において$$\eta=0$$まわりが上に凸となる．
自由エネルギーを含む完全な熱力学函数は熱平衡状態において定義されることから，平衡値でない$$\eta$$を変数にもつ$$F$$は
現象論的自由エネルギーから得る　下側凸包絡とFenchel–Moreauの定理の拡張　外場への共軛量
